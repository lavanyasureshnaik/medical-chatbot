...
def user_account():
      ...
      # if request.method == 'POST':
      session['logged_in'] = True
      s4 = cur.execute('select * from doctor where specialist= "general"')
      s5 = cur.fetchall()
      print("s5",s5)
      return render_template('user_account.html', m = s5  )
...
def skin():
      ...
      # if request.method == 'POST':
      session['logged_in'] = True
      s2 = cur.execute('select * from doctor where specialist= "skin"')
      s3 = s2.fetchall()
      print("s",s3)
      return render_template('skin.html',p = s3 )
...
def eye():
      ...
      # if request.method == 'POST':
      session['logged_in'] = True
      s2 = cur.execute('select * from doctor where specialist= "eye"')
      s3 = s2.fetchall()
      print("s",s3)
      return render_template('eye.html', d = s3 )
